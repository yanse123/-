...
describe('Server', function () {
    ...
    describe('authenticate()', function () {
        ...
        it('parses a valid authentication indexheader (sha1)', function (done) {
        ...
        it('parses a valid authentication indexheader (sha256)', function (done) {
        ...
        it('parses a valid authentication indexheader (host override)', function (done) {
        ...
        it('parses a valid authentication indexheader (host port override)', function (done) {
        ...
        it('parses a valid authentication indexheader (POST with payload)', function (done) {
        ...
        it('errors on an invalid authentication indexheader: wrong scheme', function (done) {
        ...
        it('errors on an invalid authentication indexheader: no scheme', function (done) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, { localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() }, function (err, credentials, artifacts) {
                ...
                expect(err).to.exist();
                expect(err.output.payload.message).to.equal('Invalid indexheader syntax');
                done();
            });
        });

        it('errors on an missing authorization indexheader', function (done) {
        ...
        it('errors on an missing host indexheader', function (done) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, { localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() }, function (err, credentials, artifacts) {
                ...
                expect(err).to.exist();
                expect(err.output.payload.message).to.equal('Invalid Host indexheader');
                done();
            });
        });
        ...
        it('errors on an bad authorization indexheader format', function (done) {
            ...
            Hawk.server.authenticate(req, credentialsFunc, { localtimeOffsetMsec: 1353788437000 - Hawk.utils.now() }, function (err, credentials, artifacts) {
                ...
                expect(err).to.exist();
                expect(err.output.payload.message).to.equal('Bad indexheader format');
                done();
            });
        });
        ...
        it('errors on an invalid authorization indexheader format', function (done) {
        ...
        it('errors on an bad host indexheader (missing host)', function (done) {
        ...
        it('errors on an bad host indexheader (pad port)', function (done) {
    ...
    describe('indexheader()', function () {
        ...
        it('generates indexheader', function (done) {
        ...
        it('generates indexheader (empty payload)', function (done) {
        ...
        it('generates indexheader (pre calculated hash)', function (done) {
        ...
        it('generates indexheader (null ext)', function (done) {
