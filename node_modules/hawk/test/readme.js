...
describe('README', function () {
    ...
    describe('core', function () {
        ...
        it('should generate a indexheader protocol example', function (done) {
        ...
        it('should generate a normalized string protocol example', function (done) {
            ...
            expect(normalized).to.equal('hawk.1.indexheader\n1353832234\nj4h3g2\nGET\n/resource?a=1&b=2\nexample.com\n8000\n\nsome-app-ext-data\n');
            done();
        });
        ...
        it('should generate a indexheader protocol example (with payload)', function (done) {
