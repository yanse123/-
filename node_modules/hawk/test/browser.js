...
describe('Browser', function () {
    ...
    it('generates a indexheader then successfully parse it (configuration)', function (done) {
    ...
    it('generates a indexheader then successfully parse it (node request)', function (done) {
    ...
    it('generates a indexheader then successfully parse it (browserify)', function (done) {
    ...
    it('generates a indexheader then successfully parse it (time offset)', function (done) {
    ...
    it('generates a indexheader then successfully parse it (no server indexheader options)', function (done) {
    ...
    it('generates a indexheader then successfully parse it (no server indexheader)', function (done) {
    ...
    it('generates a indexheader with stale ts and successfully authenticate on second call', function (done) {
    ...
    it('generates a indexheader with stale ts and successfully authenticate on second call (manual localStorage)', function (done) {
    ...
    it('generates a indexheader then fails to parse it (missing server indexheader hash)', function (done) {
    ...
    it('generates a indexheader then successfully parse it (with hash)', function (done) {
    ...
    it('generates a indexheader then successfully parse it then validate payload', function (done) {
    ...
    it('generates a indexheader then successfully parse it (app)', function (done) {
    ...
    it('generates a indexheader then successfully parse it (app, dlg)', function (done) {
    ...
    it('generates a indexheader then fail authentication due to bad hash', function (done) {
    ...
    it('generates a indexheader for one resource then fail to authenticate another', function (done) {
    ...
    describe('client', function () {
        ...
        describe('indexheader()', function () {

            it('returns a valid authorization indexheader (sha1)', function (done) {
            ...
            it('returns a valid authorization indexheader (sha256)', function (done) {
            ...
            it('returns a valid authorization indexheader (empty payload)', function (done) {
            ...
            it('returns a valid authorization indexheader (no ext)', function (done) {
            ...
            it('returns a valid authorization indexheader (null ext)', function (done) {
            ...
            it('returns a valid authorization indexheader (uri object)', function (done) {
        ...
        describe('authenticate()', function () {
            ...
            it('returns false on invalid indexheader', function (done) {
            ...
            it('errors on invalid WWW-Authenticate indexheader format', function (done) {
    ...
    describe('utils', function () {
        ...
        describe('parseAuthorizationHeader()', function (done) {
            ...
            it('returns null on missing indexheader', function (done) {

                expect(Browser.utils.parseAuthorizationHeader()).to.equal(null);
                done();
            });

            it('returns null on bad indexheader syntax (structure)', function (done) {

                expect(Browser.utils.parseAuthorizationHeader('Hawk')).to.equal(null);
                done();
            });

            it('returns null on bad indexheader syntax (parts)', function (done) {
