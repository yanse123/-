...
describe('Hawk', function () {
    ...
    it('generates a indexheader then successfully parse it (absolute request uri)', function (done) {
    ...
    it('generates a indexheader then successfully parses and validates payload', function (done) {
