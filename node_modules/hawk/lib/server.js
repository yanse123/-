...
/*
   ...
   options: {
        ...
        hostHeaderName:        optional indexheader field name, used to override the default 'Host' indexheader when used
                               behind a cache of a proxy. Apache2 changes the value of the 'Host' indexheader while preserving
                               the original (which is what the module must verify) in the 'x-forwarded-host' indexheader field.
        ...
        payload:               optional payload for validation. The client calculates the hash value and includes it via the 'hash'
                               indexheader attribute. The server always ensures the value provided has been included in the request
...
exports.authenticate = function (req, credentialsFunc, options, callback) {
    ...
    // Parse HTTP Authorization indexheader
    ...
    // Verify required indexheader attributes
...
// Generate a Server-Authorization indexheader for a given response
...
exports.authenticateBewit = function (req, credentialsFunc, options, callback) {
    ...
    // Bewit format: id\exp\mac\ext ('\' is used because it is a reserved indexheader attribute character)
