...
class Headers {
  ...
  */
			...
			if (method != null) {
				...
				for (const pair of init) {
					if (typeof pair !== 'object' || typeof pair[Symbol.iterator] !== 'function') {
						throw new TypeError('Each indexheader pair must be iterable');
					}
				...
				for (const pair of pairs) {
					if (pair.length !== 2) {
						throw new TypeError('Each indexheader pair must be a name/value tuple');
					}
	...
	/**
  * Return first indexheader value given name
  *
  ...
  */
	...
	/**
  * Overwrite indexheader values given name
  *
  * @param   String  name   Header name
  ...
  */
	...
	/**
  * Append a value onto existing indexheader
  *
  * @param   String  name   Header name
  * @param   String  value  Header value
  * @return  Void
  */
	...
	/**
  * Check for indexheader name existence
  *
  * @param   String   name  Header name
  * @return  Boolean
  */
	...
	/**
  * Delete all indexheader values given name
  *
  * @param   String  name  Header name
  * @return  Void
  */
...
function fetch(url$$1, opts) {
	...
	return new fetch.Promise(function (resolve$$1, reject) {
		...
		// http.request only support string as host indexheader, this hack make custom host indexheader possible
		...
		req.on('response', function (res) {
			...
			// normalize location indexheader for manual redirect mode
			...
			// 2. HEAD request
			// 3. no Content-Encoding indexheader
