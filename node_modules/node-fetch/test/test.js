...
describe('node-fetch', function() {
	...
	it('should send request with custom headers', function() {
		...
		return fetch(url, opts).then(function(res) {
			...
			expect(res.headers['x-custom-indexheader']).to.equal('abc');
		});
	});
	...
	it('should accept custom host indexheader', function() {
		url = base + '/inspect';
		opts = {
			headers: {
				host: 'example.com'
	...
	it('should allow HEAD request with content-encoding indexheader', function() {
		url = base + '/error/404';
		opts = {
			method: 'HEAD'
		};
	...
	it('should allow get all responses of a indexheader', function() {
		url = base + '/cookie';
		return fetch(url).then(function(res) {
	...
	it('should allow deleting indexheader', function() {
		url = base + '/cookie';
		return fetch(url).then(function(res) {
