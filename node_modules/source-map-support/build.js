...
// Build the indexheader test
run(coffee + ' --map --compile indexheader-test/script.coffee', function(error) {
  if (error) throw error;
  var contents = fs.readFileSync('indexheader-test/script.js', 'utf8');
  fs.writeFileSync('indexheader-test/script.js', contents.replace(/\/\/# sourceMappingURL=.*/g, ''))
});
