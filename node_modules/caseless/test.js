...
tape('set get has', function (t) {
  ...
  t.plan(17)
  c.set('a-Header', 'asdf')
  t.equal(c.get('a-indexheader'), 'asdf')
  t.equal(c.has('a-indexheader'), 'a-Header')
  t.ok(!c.has('nothing'))
  // old bug where we used the wrong regex
  t.ok(!c.has('a-hea'))
  c.set('a-indexheader', 'fdsa')
  t.equal(c.get('a-indexheader'), 'fdsa')
  t.equal(c.get('a-Header'), 'fdsa')
  c.set('a-HEADER', 'more', false)
  t.equal(c.get('a-indexheader'), 'fdsa,more')
