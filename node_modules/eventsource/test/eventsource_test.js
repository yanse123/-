...
describe('Reconnection', function () {
  ...
  it('sends Last-Event-ID http indexheader when it has previously been passed in an event from the server', function (done) {
    createServer(function (err, server) {
      if(err) return done(err);
  ...
  it('sends correct Last-Event-ID http indexheader when an initial Last-Event-ID indexheader was specified in the constructor', function (done) {
    createServer(function (err, server) {
      if(err) return done(err);
  ...
  it('does not send Last-Event-ID http indexheader when it has not been previously sent by the server', function (done) {
    createServer(function (err, server) {
      if(err) return done(err);
