...
<html lang="en">
<head>
    <title>Code coverage report for lib/spdy-transport/connection.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/spdy-transport/</a> connection.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.62% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>330/390</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.28% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>152/187</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>320/375</span>
      </div>
    </div>
  </div>
...
836
837
838</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">448×</span>
<span class="cline-any cline-yes">5164×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">448×</span>
<span class="cline-any cline-yes">448×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3948×</span>
<span class="cline-any cline-yes">4×</span>
<span class="cline-any cline-yes">4×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3944×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3313×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3313×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3719×</span>
<span class="cline-any cline-yes">3027×</span>
...
&nbsp;
  ...
  state.acceptPush = options.acceptPush === undefined
    ? !state.isServer
    : <span class="branch-1 cbranch-no" title="branch not covered" >options.acceptPush</span>
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.maxChunk === false) { <span class="cstat-no" title="statement not covered" >state.maxChunk = Infinity }</span> else <span class="missing-if-branch" title="else path not taken" >E</span>if (options.maxChunk === undefined) { state.maxChunk = transport.protocol.base.constants.DEFAULT_MAX_CHUNK } else {
<span class="cstat-no" title="statement not covered" >    state.maxChunk = options.maxChunk</span>
  }
&nbsp;
  // Connection-level flow control
  var windowSize = options.windowSize || <span class="branch-1 cbranch-no" title="branch not covered" >1 &lt;&lt; 20</span>
...
&nbsp;
  ...
  state.parser.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span>
<span class="cstat-no" title="statement not covered" >    self._onParserError(err)</span>
  })
&nbsp;
  // Propagate framer errors
  state.framer.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span>
...
&nbsp;
  ...
  this.socket.on('error', <span class="fstat-no" title="function not covered" >function onSocketError (e) {</span>
<span class="cstat-no" title="statement not covered" >    self.emit('error', e)</span>
  })
&nbsp;
  this.socket.once('close', <span class="fstat-no" title="function not covered" >function onclose () {</span>
<span class="cstat-no" title="statement not covered" >    var err = new Error('socket hang up')</span>
<span class="cstat-no" title="statement not covered" >    err.code = 'ECONNRESET'</span>
<span class="cstat-no" title="statement not covered" >    self.destroyStreams(err)</span>
<span class="cstat-no" title="statement not covered" >    self.emit('close', err)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (state.pair) {</span>
<span class="cstat-no" title="statement not covered" >      pool.put(state.pair)</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    state.framer.resume()</span>
  })
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function _onWindowOverflow () {</span>
<span class="cstat-no" title="statement not covered" >    self._onWindowOverflow()</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!prev) {
...
&nbsp;
  if (!state.isServer) {
    framer.prefaceFrame()
    <span class="missing-if-branch" title="if path not taken" >I</span>if (state.xForward !== null) {
<span class="cstat-no" title="statement not covered" >      framer.xForwardedFor({ host: state.xForward })</span>
    }
  }
&nbsp;
...
&nbsp;
Connection.prototype._onParserError = <span class="fstat-no" title="function not covered" >function _onParserError (err) {</span>
<span class="cstat-no" title="statement not covered" >  var state = this._spdyState</span>
&nbsp;
  // Prevent further errors
<span class="cstat-no" title="statement not covered" >  state.parser.kill()</span>
&nbsp;
  // Send GOAWAY
<span class="cstat-no" title="statement not covered" >  if (err instanceof transport.protocol.base.utils.ProtocolError) {</span>
<span class="cstat-no" title="statement not covered" >    this._goaway({</span>
...
<span class="cstat-no" title="statement not covered" >      if (this._isGoaway(frame.id)) { <span class="cstat-no" title="statement not covered" >return }</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      state.debug('id=0 stream=%d not found', frame.id)</span>
<span class="cstat-no" title="statement not covered" >      state.framer.rstFrame({ id: frame.id, code: 'INVALID_STREAM' })</span>
...
&nbsp;
  if (stream) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (state.xForward === null) {
...
&nbsp;
Connection.prototype._onWindowOverflow = <span class="fstat-no" title="function not covered" >function _onWindowOverflow () {</span>
<span class="cstat-no" title="statement not covered" >  var state = this._spdyState</span>
<span class="cstat-no" title="statement not covered" >  state.debug('id=0 window overflow')</span>
<span class="cstat-no" title="statement not covered" >  this._goaway({</span>
    lastId: state.stream.lastId.both,
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (uri.push &amp;&amp; !state.acceptPush) {
<span class="cstat-no" title="statement not covered" >    state.debug('id=0 push disabled promisedId=%d', id)</span>
&nbsp;
    // Fatal error
<span class="cstat-no" title="statement not covered" >    this._goaway({</span>
      lastId: state.stream.lastId.both,
...
<span class="cstat-no" title="statement not covered" >    isGoaway = true</span>
  }
&nbsp;
...
Connection.prototype._onSessionWindowDrain = function _onSessionWindowDrain () {
  var state = this._spdyState
  <span class="missing-if-branch" title="if path not taken" >I</span>if (state.version &lt; 3.1 &amp;&amp; !(state.isServer &amp;&amp; state.autoSpdy31)) {
<span class="cstat-no" title="statement not covered" >    return</span>
  }
&nbsp;
  var delta = state.window.recv.getDelta()
  <span class="missing-if-branch" title="if path not taken" >I</span>if (delta === 0) {
<span class="cstat-no" title="statement not covered" >    return</span>
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!state.ping.map[hex]) {
<span class="cstat-no" title="statement not covered" >    return</span>
  }
  var ping = state.ping.map[hex]
  delete state.ping.map[hex]
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (ping.cb) {
    ping.cb(null)
  }
}
&nbsp;
...
&nbsp;
  ...
  if (this._isGoaway(stream.id)) {
    ...
    process.nextTick(function () {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (callback) { callback(err) } else {
...
<span class="cstat-no" title="statement not covered" >        if (callback) { <span class="cstat-no" title="statement not covered" >return callback(err) }</span> else { <span class="cstat-no" title="statement not covered" >return stream.emit('error', err) }</span></span>
      }
&nbsp;
      if (callback) {
        callback(null, stream)
...
&nbsp;
Connection.prototype.destroyStreams = <span class="fstat-no" title="function not covered" >function destroyStreams (err) {</span>
<span class="cstat-no" title="statement not covered" >  var state = this._spdyState</span>
<span class="cstat-no" title="statement not covered" >  Object.keys(state.stream.map).forEach(<span class="fstat-no" title="function not covered" >function (id) {</span></span>
<span class="cstat-no" title="statement not covered" >    var stream = state.stream.map[id]</span>
&nbsp;
...
Connection.prototype.sendXForwardedFor = function sendXForwardedFor (host) {
  var state = this._spdyState
  <span class="missing-if-branch" title="else path not taken" >E</span>if (state.version !== null) {
    state.framer.xForwardedFor({ host: host })
  } else {
<span class="cstat-no" title="statement not covered" >    state.xForward = host</span>
  }
}
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._isGoaway(stream.id)) {
<span class="cstat-no" title="statement not covered" >    err = new Error('Can\'t send PUSH_PROMISE after GOAWAY')</span>
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (uri.push &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!state.acceptPush)</span> {
<span class="cstat-no" title="statement not covered" >    err = new Error(</span>
        'Can\'t send PUSH_PROMISE, other side won\'t accept it')
<span class="cstat-no" title="statement not covered" >    process.nextTick(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      if (callback) { <span class="cstat-no" title="statement not covered" >callback(err) }</span> else {</span>
<span class="cstat-no" title="statement not covered" >        stream.emit('error', err)</span>
      }
    })
<span class="cstat-no" title="statement not covered" >    return stream</span>
...
<div class='push'></div><!-- for sticky indexfooter -->
</div><!-- /wrapper -->
