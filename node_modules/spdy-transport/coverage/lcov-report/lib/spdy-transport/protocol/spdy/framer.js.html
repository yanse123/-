...
<html lang="en">
<head>
    <title>Code coverage report for lib/spdy-transport/protocol/spdy/framer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/spdy-transport/protocol/spdy/</a> framer.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.84% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>225/245</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.55% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>84/103</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">92.05% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>220/239</span>
      </div>
    </div>
  </div>
...
518
519
520</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">1409×</span>
<span class="cline-any cline-yes">1409×</span>
<span class="cline-any cline-yes">6×</span>
<span class="cline-any cline-yes">1403×</span>
<span class="cline-any cline-yes">1370×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1421×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1409×</span>
<span class="cline-any cline-yes">1409×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-yes">2673×</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1540×</span>
<span class="cline-any cline-yes">1386×</span>
<span class="cline-any cline-yes">1386×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  var loweredHeaders = {}
  Object.keys(headers || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.map(function (key) {
...
Framer.prototype._frame = function _frame (frame, body, callback) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.version) {
...
<span class="cstat-no" title="statement not covered" >      this._frame(frame, body, callback)</span>
    })
<span class="cstat-no" title="statement not covered" >    return</span>
  }
&nbsp;
...
Framer.prototype._synFrame = function _synFrame (frame, callback) {
  var self = this
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!frame.path) {
<span class="cstat-no" title="statement not covered" >    throw new Error('`path` is required frame argument')</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        return self.emit('error', err)</span>
      }
    }
&nbsp;
    self._frame({
...
&nbsp;
  this.headersToDict(frame.headers, null, function (err, chunks) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {
<span class="cstat-no" title="statement not covered" >      if (callback) { <span class="cstat-no" title="statement not covered" >return callback(err) }</span> else {</span>
<span class="cstat-no" title="statement not covered" >        return self.emit('error', err)</span>
      }
    }
&nbsp;
...
Framer.prototype.dataFrame = function dataFrame (frame, callback) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.version) {
<span class="cstat-no" title="statement not covered" >    return this.on('version', <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      this.dataFrame(frame, callback)</span>
    })
  }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (frame.extra) {
<span class="cstat-no" title="statement not covered" >      buf.write(frame.extra)</span>
    }
  }, callback)
}
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options[name] !== undefined) {
...
&nbsp;
Framer.prototype.priorityFrame = <span class="fstat-no" title="function not covered" >function priorityFrame (frame, callback) {</span>
