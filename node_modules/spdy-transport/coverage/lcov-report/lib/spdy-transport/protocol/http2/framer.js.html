...
<html lang="en">
<head>
    <title>Code coverage report for lib/spdy-transport/protocol/http2/framer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/spdy-transport/protocol/http2/</a> framer.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">96.15% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>225/234</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<span class="cline-any cline-yes">1212×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">300×</span>
<span class="cline-any cline-yes">300×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2093×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2093×</span>
<span class="cline-any cline-yes">2093×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2091×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  if (frames.length === 0) {
    this._frame({
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (body) { body(buf) }
    }, callback)
  }
}
&nbsp;
...
<span class="branch-2 cbranch-no" title="branch not covered" >         !priority.exclusive</span>
}
&nbsp;
...
&nbsp;
  if (kind === 'request') {
    ...
    pairs.push({ name: ':status', value: (frame.status || <span class="branch-1 cbranch-no" title="branch not covered" >200)</span> + '' })
  }
&nbsp;
  var self = this
...
&nbsp;
    // Mostly for testing
    <span class="missing-if-branch" title="if path not taken" >I</span>if (frame.fin) {
<span class="cstat-no" title="statement not covered" >      flags |= constants.flags.END_STREAM</span>
    }
&nbsp;
    self._continuationFrame({
      id: frame.promisedId,
...
&nbsp;
      buf.writeUInt32BE((priority.exclusive ? <span class="branch-0 cbranch-no" title="branch not covered" >0x80000000 </span>: 0) |
                        priority.parent)
      buf.writeUInt8((priority.weight | 0) - 1)
    }, callback)
  }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (frame.extra) { <span class="cstat-no" title="statement not covered" >buf.write(frame.extra) }</span>
  }, callback)
}
&nbsp;
