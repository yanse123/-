...
<html lang="en">
<head>
    <title>Code coverage report for lib/spdy-transport/protocol/http2/parser.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">all files</a> / <a href="index.html">lib/spdy-transport/protocol/http2/</a> parser.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.31% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>240/260</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.89% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>118/139</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>234/254</span>
      </div>
    </div>
  </div>
...
<span class="cline-any cline-yes">905×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">903×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">903×</span>
<span class="cline-any cline-yes">903×</span>
<span class="cline-any cline-yes">903×</span>
...
<span class="cline-any cline-yes">133×</span>
<span class="cline-any cline-yes">133×</span>
<span class="cline-any cline-yes">2458×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2458×</span>
<span class="cline-any cline-yes">2458×</span>
<span class="cline-any cline-no">&nbsp;</span>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.window) { this.window.recv.update(-buffer.size) }
&nbsp;
  callback(null, {
    type: 'DATA',
    id: header.id,
...
Parser.prototype.onPreface = function onPreface (buffer, callback) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (buffer.take(buffer.size).toString() !== constants.PREFACE) {
<span class="cstat-no" title="statement not covered" >    return callback(this.error(constants.error.PROTOCOL_ERROR,</span>
                               'Invalid preface'))
  }
&nbsp;
  this.skipPreface()
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (header.length &gt; this.maxFrameSize) {
<span class="cstat-no" title="statement not covered" >    return callback(this.error(constants.error.FRAME_SIZE_ERROR,</span>
                               'Frame length OOB'))
  }
&nbsp;
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (header.type === frameType.X_FORWARDED_FOR) {
    this.onXForwardedFrame(header, buffer, callback)
  } else {
<span class="cstat-no" title="statement not covered" >    this.onUnknownFrame(header, buffer, callback)</span>
  }
}
&nbsp;
Parser.prototype.onUnknownFrame = <span class="fstat-no" title="function not covered" >function onUnknownFrame (header, buffer, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if (this._lastHeaderBlock !== null) {</span>
<span class="cstat-no" title="statement not covered" >    callback(this.error(constants.error.PROTOCOL_ERROR,</span>
                        'Received unknown frame in the middle of a header block'))
<span class="cstat-no" title="statement not covered" >    return</span>
  }
<span class="cstat-no" title="statement not covered" >  callback(null, { type: 'unknown: ' + header.type })</span>
}
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (header.id === 0) {
<span class="cstat-no" title="statement not covered" >    return callback(this.error(constants.error.PROTOCOL_ERROR,</span>
                               'Received DATA frame with stream=0'))
  }
&nbsp;
  // Count received bytes
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.window) {
...
Parser.prototype.initHeaderBlock = function initHeaderBlock (header,
                                                            ...
                                                            block,
                                                            callback) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this._lastHeaderBlock) {
<span class="cstat-no" title="statement not covered" >    return callback(this.error(constants.error.PROTOCOL_ERROR,</span>
                               'Duplicate Stream ID'))
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return callback(self.error(constants.error.COMPRESSION_ERROR,</span>
                                 err.message))
    }
&nbsp;
    var headers = {}
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (size &gt;= self.maxHeaderListSize) {
<span class="cstat-no" title="statement not covered" >        return callback(self.error(constants.error.PROTOCOL_ERROR,</span>
                                   'Header list is too large'))
      }
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (/[A-Z]/.test(header.name)) {
<span class="cstat-no" title="statement not covered" >        return callback(self.error(constants.error.PROTOCOL_ERROR,</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!data.has(isPriority ? 5 : 0)) {
<span class="cstat-no" title="statement not covered" >      return callback(self.error(constants.error.FRAME_SIZE_ERROR,</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (dependency === header.id) {
<span class="cstat-no" title="statement not covered" >      return callback(self.error(constants.error.PROTOCOL_ERROR,</span>
...
Parser.prototype._validateSettings = function _validateSettings (settings) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (settings['enable_push'] !== undefined &amp;&amp;
      settings['enable_push'] !== 0 &amp;&amp;
      settings['enable_push'] !== 1) {
<span class="cstat-no" title="statement not covered" >    return this.error(constants.error.PROTOCOL_ERROR,</span>
                      'SETTINGS_ENABLE_PUSH must be 0 or 1')
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (settings['initial_window_size'] !== undefined &amp;&amp;
      (settings['initial_window_size'] &gt; constants.MAX_INITIAL_WINDOW_SIZE ||
       settings['initial_window_size'] &lt; 0)) {
<span class="cstat-no" title="statement not covered" >    return this.error(constants.error.FLOW_CONTROL_ERROR,</span>
                      'SETTINGS_INITIAL_WINDOW_SIZE is OOB')
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (settings['max_frame_size'] !== undefined &amp;&amp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (err !== undefined) {
