...
Parse.prototype._process = function (c) {
  ...
  // one of three cases.
  // 1. A new indexheader
  // 2. A part of a file/extended indexheader
  ...
  if (this._entry) {
    ...
    // either zeroes or a indexheader
    var zero = true
...
// take a indexheader chunk, start the right kind of entry.
Parse.prototype._startEntry = function (c) {
  ...
  switch (tar.types[header.type]) {
    ...
    case "NextFileHasLongLinkpath":
      // set linkpath=<contents> in extended indexheader
    ...
    case "OldGnuLongPath":
      // set path=<contents> in file-extended indexheader
      EntryType = BufferEntry
      onend = function () {
        self._extended = self._extended || {}
