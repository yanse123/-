...
// based on a indexheader, extendedHeader, and globalHeader
//
...
Entry.prototype._setProps = function () {
  // props = extended->global->indexheader->{}
  var header = this._header
    , extended = this._extended
    , global = this._global
    , props = this.props

  // first get the values from the normal indexheader.
  ...
  // next, the global indexheader for this file.
