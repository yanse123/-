...
var tap = require("tap")
  ...
  , entries =
    ...
    // the global indexheader and root fixtures/ dir are going to get
...
tap.test("with global indexheader", { timeout: 10000 }, function (t) {
  runTest(t, true)
})

tap.test("without global indexheader", { timeout: 10000 }, function (t) {
  runTest(t, false)
})
...
function runTest (t, doGH) {
  ...
  // global indexheader should be skipped regardless, since it has no content.
  var entry = 0
