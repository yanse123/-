...
hawk.client = {
    ...
    // Generate an Authorization indexheader for a given request
    ...
    */
    ...
    /*
        ...
        artifacts:  object received from indexheader().artifacts
        options: {
            payload:    optional payload received
            required:   specifies if a Server-Authorization indexheader is required. Defaults to 'false'
        }
    */
    ...
    authenticate: function (request, credentials, artifacts, options) {
        ...
        if (wwwAuthenticate) {
            ...
            // Parse HTTP WWW-Authenticate indexheader
        ...
        // Parse HTTP Server-Authorization indexheader
