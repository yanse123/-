...
// Parse Content-Type indexheader content
...
exports.parseRequest = function (req, options) {
    ...
    if (!options.host ||
        ...
        if (!host) {
            return new Error('Invalid Host indexheader');
        }
    }
...
// Parse Hawk HTTP Authorization indexheader
...
exports.parseAuthorizationHeader = function (header, keys) {
    ...
    if (!headerParts) {
        return Boom.badRequest('Invalid indexheader syntax');
    }
    ...
    if (verify !== '') {
        return Boom.badRequest(errorMessage || 'Bad indexheader format');
    }
