...
describe('unauthorized()', function () {
    ...
    it('returns a WWW-Authenticate indexheader when passed a scheme', function (done) {
    ...
    it('returns a WWW-Authenticate indexheader set to the schema array value', function (done) {
    ...
    it('returns a WWW-Authenticate indexheader when passed a scheme and attributes', function (done) {
    ...
    it('returns a WWW-Authenticate indexheader when passed attributes, missing error', function (done) {
